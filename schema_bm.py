...
schema = {'field1': (Unicode, ''), 'field2': (Unicode, ''),
          ...
          'fieldD28': (Integer, None, {'sum': ('fieldD15Z', 'fieldD16Z',
                                               'fieldD17Z', 'fieldD18Z',
                                               'fieldD19', 'fieldD20',
                                               'fieldD21', 'fieldD22',
                                               'fieldD23', 'fieldD24')}),
          ...
          'fieldE18X': (Integer, None, {'sum': ('fieldE11X', 'fieldE12X',
                                                'fieldE13X', 'fieldE14X',
                                                'fieldE15X', 'fieldE16X',)}),
          'fieldE18Y': (Integer, None, {'sum': ('fieldE11Y', 'fieldE12Y',
                                                'fieldE13Y', 'fieldE14Y',
                                                'fieldE15Y', 'fieldE16Y',)}),
          'fieldE18Z': (Integer, None, {'sum': ('fieldE11Z', 'fieldE12Z',
                                                'fieldE13Z', 'fieldE14Z',
                                                'fieldE15Z', 'fieldE16Z',)}),
          #
          ...
          'fieldE28X': (Integer, None, {'sum': ('fieldE21X', 'fieldE22X',
                                                'fieldE23X', 'fieldE24X',
                                                'fieldE25X', 'fieldE26X',)}),
          'fieldE28Y': (Integer, None, {'sum': ('fieldE21Y', 'fieldE22Y',
                                                'fieldE23Y', 'fieldE24Y',
                                                'fieldE25Y', 'fieldE26Y',)}),
          'fieldE28Z': (Integer, None, {'sum': ('fieldE21Z', 'fieldE22Z',
                                                'fieldE23Z', 'fieldE24Z',
                                                'fieldE25Z', 'fieldE26Z',)}),
          #
          ...
          'fieldF24': (Boolean, '', {'depend_field': ('fieldF25', 'fieldF26',
                                                      'fieldF27', 'fieldF28',
                                                      'fieldF29',
                                                      'fieldF30',)}),
          ...
          'fieldH15': (Boolean, ''),
          'fieldH15': (Boolean, '', {'depend_field': ('fieldH151', 'fieldH152',
                                                      'fieldH153',
                                                      'fieldH154',)}),
          'fieldH151': (Boolean, ''), 'fieldH152': (Boolean, ''),
          'fieldH153': (Boolean, ''), 'fieldH154': (Boolean, ''),
          'fieldH16': (Boolean, '', {'depend_field': ('fieldH17', 'fieldH18',
                                                      'fieldH19',
                                                      'fieldH20',)}),
          ...
          #
          'fieldH31': (Boolean, '', {'depend_field': ('fieldH32', 'fieldH33',
                                                      'fieldH34', 'fieldH35',
                                                      'fieldH36', 'fieldH37',
                                                      'fieldH39')}),
          #
