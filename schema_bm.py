...
# Import from scrib
from datatypes import Checkboxes, Integer, Decimal, EPCI_Statut
...
schema = {'field1': (Unicode, ''), 'field2': (Unicode, ''),
          ...
          #'field13': (Checkboxes, '',{'depend_field' : ('fieldK40','fieldK41', 'fieldK42',
          #                                'fieldK43', 'fieldK44','fieldK45', 'fieldK46')}),
          'field13': (Checkboxes, '',{'depend_field' : ('fieldK40')}),
          'field14': (Checkboxes, ''),
          'field15': (Unicode, ''),
...
#           'fieldB15': (Integer, None),
		  'fieldB16': (Boolean, '', {'depend_field' : ('fieldB17',) }),
		  'fieldB17': (Boolean, ''),
          #
...
# 	      'fieldD25Z': (Integer, None, {'sum': ('fieldD25X', 'fieldD25Y' )}),
          'fieldD26X': (Integer, None), 'fieldD26Y': (Integer, None),
          'fieldD26Z': (Integer, None, {'sum': ('fieldD26X', 'fieldD26Y')}),
          'fieldD27X': (Integer, None), 'fieldD27Y': (Integer, None),
          'fieldD27Z': (Integer, None, {'sum': ('fieldD27X', 'fieldD27Y')}),
          'fieldD28': (Integer, None, {'sum': ('fieldD15Z','fieldD16Z','fieldD17Z','fieldD18Z','fieldD19',
                                                'fieldD20','fieldD21','fieldD22','fieldD23','fieldD24' )}),
	  #
...
#           'fieldE17Z': (Integer, None, {'sum': ('fieldE17X', 'fieldE17Y')}),
          'fieldE18X': (Integer, None, {'sum': ('fieldE11X', 'fieldE12X','fieldE13X', 'fieldE14X','fieldE15X', 'fieldE16X',)}),
          'fieldE18Y': (Integer, None, {'sum': ('fieldE11Y', 'fieldE12Y','fieldE13Y', 'fieldE14Y','fieldE15Y', 'fieldE16Y',)}),
          'fieldE18Z': (Integer, None, {'sum': ('fieldE11Z', 'fieldE12Z','fieldE13Z', 'fieldE14Z','fieldE15Z', 'fieldE16Z',)}),
          #
...
#          'fieldE27Z': (Integer, None, {'sum': ('fieldE27X', 'fieldE27Y')}),
          'fieldE28X': (Integer, None, {'sum': ('fieldE21X', 'fieldE22X','fieldE23X', 'fieldE24X','fieldE25X', 'fieldE26X',)}),
          'fieldE28Y': (Integer, None, {'sum': ('fieldE21Y', 'fieldE22Y','fieldE23Y', 'fieldE24Y','fieldE25Y', 'fieldE26Y',)}),
          'fieldE28Z': (Integer, None, {'sum': ('fieldE21Z', 'fieldE22Z','fieldE23Z', 'fieldE24Z','fieldE25Z', 'fieldE26Z',)}),
          #
...
#           'fieldE38Z': (Integer, None, {'sum': ('fieldE38X', 'fieldE38Y')}),
          ...
          'fieldE661X': (Integer, None), 'fieldE661Y': (Integer, None),
          'fieldE661Z': (Integer, None, {'sum': ('fieldE661X', 'fieldE661Y')}),
...
#           'fieldF22': (Boolean, ''), 'fieldF23': (Boolean, ''),
           'fieldF24': (Boolean, '', {'depend_field' :
                                            ('fieldF25', 'fieldF26','fieldF27', 'fieldF28',
                                             'fieldF29', 'fieldF30',)}),
          'fieldF25': (Boolean, ''), 'fieldF26': (Boolean, ''),
          'fieldF27': (Boolean, ''), 'fieldF28': (Boolean, ''),
          'fieldF29': (Boolean, ''), 'fieldF30': (Boolean, ''),
          ...
          'fieldH15': (Boolean, '', {'depend_field' : ('fieldH151',
                                                              'fieldH152',
                                                              'fieldH153',
                                                              'fieldH154',)}),
          'fieldH151': (Boolean, ''), 'fieldH152': (Boolean, ''),
          'fieldH153': (Boolean, ''), 'fieldH154': (Boolean, ''),
          ...
          'fieldH31': (Boolean, '',
                       {'depend_field' : ('fieldH32', 'fieldH33', 'fieldH34',
                                          'fieldH35', 'fieldH36', 'fieldH37','fieldH39')}),
          #
          #
          'fieldH32': (Boolean, ''),
          ...
          'fieldK40': (Boolean, '', {'depend_field' : ('fieldK41', 'fieldK42',
                                          'fieldK43', 'fieldK44','fieldK45', 'fieldK46')}),

          'fieldK41': (Boolean, ''),
          'fieldK42': (Boolean, ''), 'fieldK43': (Boolean, ''),
          'fieldK44': (Boolean, ''), 'fieldK45': (Boolean, ''),
          'fieldK46': (Boolean, ''),
...
alertes = [('A', u"E61Z/E11Z = prix moyen d'un livre", 'E61Z / E11Z' ),
           ...
           ('E', u"E73Z/E46Z = prix moyen d'un document patrimonial",
                   'E73Z/E46Z' ),
